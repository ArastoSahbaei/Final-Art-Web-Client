...
export const GameController = () => {
	...
	const fight = (index: number, card: card) => {
		...
		adjacentValues.S && card.cardValues.S > tiles[adjacentValues.S - 1].card.cardValues.N && (tilesCopy[adjacentValues.S - 1] = { ...tilesCopy[adjacentValues.S - 1], tileControlledBy: determinePlayerTurn() })
